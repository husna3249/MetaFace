import {client, nftcontract,tokenaddress,usercontract,userdbaddress,tokencontract,rpc} from "./config";
import Web3Modal from 'web3modal';
import {ethers} from 'ethers';
import NFTABI from './nftabi.json';
import USERABI from './userdb.json';
 import TOKENABI from './erc20.json';
import { getPayInfo, storeWallet } from "./mongo";
...
const addressstr= userdata.addressstr;
await nftctr.transferFrom(addressstr,newwallet,nftid);
const userctr= userdata.userctr;
